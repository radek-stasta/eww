...
try:
    ...
    imageOutputPath = os.path.expanduser('~') + '/.local/share/eww-output/hot'
    ...
    for app in appRows:
        ...
        if local_image_path:
            gameInfo = {"name": html.escape(name), "peak": peak, "price": price, "imgSrc": local_image_path, "appId": appId}
            new.append(gameInfo)
    ...
    for gameInfo in new:
        ...
        if len(printedGames) == 2:
            ...
            """ % (printedGames[0]["imgSrc"], printedGames[1]["imgSrc"], printedGames[0]["appId"], printedGames[0]["name"], printedGames[0]["price"], printedGames[0]["peak"], printedGames[1]["appId"], printedGames[1]["name"], printedGames[1]["price"], printedGames[1]["peak"])
    ...
    if len(printedGames) == 1:
        output += """
            ...
            """ % (printedGames[0]["imgSrc"], printedGames[0]["appId"], printedGames[0]["name"], printedGames[0]["price"], printedGames[0]["peak"])

    output += ')'

    outputFile = open(os.path.expanduser('~') + '/.local/share/eww-output/steam_hot.yuck', 'w+')
